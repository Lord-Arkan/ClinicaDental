...
/**
 * Servlet encargado de manejar el inicio y cierre de sesión de los empleados.
 * Mapea las solicitudes HTTP relacionadas con la autenticación en "/login".
 */
@WebServlet("/login")
public class LoginServlet extends HttpServlet {

    /**
     * Procesa las solicitudes comunes.
     *
    ...
    /**
     * Maneja solicitudes HTTP GET, como cerrar sesión.
     *
     * @param request el objeto {@link HttpServletRequest} que contiene la
     * solicitud del cliente.
     * @param response el objeto {@link HttpServletResponse} que contiene la
    ...
    /**
     * Maneja solicitudes HTTP POST, como la validación de credenciales de
     * inicio de sesión.
     *
     * @param request el objeto {@link HttpServletRequest} que contiene la
     * solicitud del cliente.
    ...
    /**
     * Proporciona información general sobre el servlet.
     *
