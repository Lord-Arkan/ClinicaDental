...
/**
 * Clase DAO para la gestión de citas. Proporciona métodos para editar, listar,
 * eliminar citas y obtener datos relacionados.
 */
public class CrudCitaDAO {
     ...
     * @param idDoctor el ID del doctor asociado.
     * @param fecha la nueva fecha y hora de la cita.
     * @param mensaje el nuevo mensaje de la cita.
    ...
    /**
     * Obtiene una lista de todas las citas, incluyendo datos relacionados como
     * cliente, doctor y especialidad.
     *
     * @return una lista de mapas donde cada mapa contiene los datos de la cita
     * y sus relaciones.
     */
    ...
    /**
     * Obtiene los datos relacionados de una cita específica, como cliente,
     * doctor y especialidad.
     *
     * @param idCita el ID de la cita.
     * @return un mapa con los datos de la cita y sus relaciones.
     */
    ...
    /**
     * Elimina una cita y el cliente asociado de forma transaccional.
     *
