...
public class DoctorDAO implements IGenericDAO<Doctor> {
    ...
    public Doctor buscarDoctorPorNombreApellidos(String nombre, String apellidos) throws SQLException {
        Connection cn = MySQLConexion.getConexion();
        String sql = "SELECT * FROM doctor WHERE nombre = ? AND apellidos = ?";
