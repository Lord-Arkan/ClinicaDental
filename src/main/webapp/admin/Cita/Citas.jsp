                                ...
                                <c:forEach var="citaCompleta" items="${citasCompletas}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="ControlCita?opc=5&idCita=${citaCompleta.cita.id}" class="btn btn-info btn-sm">Detalles
                                            <a href="#" class="btn btn-danger btn-sm"
                                               onclick="event.preventDefault(); confirmarEliminacion(${citaCompleta.cita.id}, ${citaCompleta.cliente.id});">Eliminar</a>
                                               
                                            <!-- <a hidden="null" href="ControlCita?opc=3&idCita=${citaCompleta.cita.id}&idCliente=${citaCompleta.cliente.id}" class="btn btn-danger btn-sm"
...
<script>
           ...
           // Confirmación de eliminación con SweetAlert para citas
           function confirmarEliminacion(idCita, idCliente) {
               Swal.fire({
                   ...
                   if (result.isConfirmed) {
                       // Construir la URL de eliminación con idCita e idCliente
                       window.location.href = 'ControlCita?opc=3&idCita=' + idCita + '&idCliente=' + idCliente;
                   }
               });
           }
