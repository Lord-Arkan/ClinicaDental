        ...
        <header id="header" class="header sticky-top">
            ...
            <div class="branding d-flex align-items-center">
                <div class="container position-relative d-flex align-items-center justify-content-between">
                    <a href="${pageContext.request.contextPath}/admin/home.jsp" class="logo d-flex align-items-center me-auto">
                        <h1 class="sitename">Clinica Jesus del Norte</h1>
                    </a>
                    ...
                    <nav id="navmenu" class="navmenu">
                        <ul>
                            ...
                            <li><a href="${pageContext.request.contextPath}/ControlCita?opc=1"><i class="bi bi-calendar-check me-2 fs-4"></i> Citas</a></li>



                            <li class="dropdown">
                                <a href="#"><i class="bi bi-database-up me-2 fs-4"></i> <span>Mantenimiento</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                                <ul>
                                    <li><a href="${pageContext.request.contextPath}/ControlCliente?opc=1"><i class="bi bi-people me-2 fs-4"></i> Pacientes</a></li>
                                    <% if ("Administrador".equals(rol)) {%>
                                    <li><a href="${pageContext.request.contextPath}/ControlDoctor?opc=1"><i class="bi bi-heart-pulse me-2 fs-4"></i> Doctores</a></li>
                                     <% }%>
                                </ul>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/admin/reportes.jsp"><i class="bi bi-bar-chart me-2 fs-4"></i>Estadísticas</a></li>
                                <% if ("Administrador".equals(rol)) {%>
                    ...
                    <div class=" d-sm-block ms-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                            <li class="d-flex flex-column align-items-center p-3">
                                <img src="${pageContext.request.contextPath}/admin/assets/img/dark_1.png" alt="Usuario" class="rounded-circle mb-2" width="60" height="60"/>
