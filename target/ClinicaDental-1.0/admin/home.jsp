...
<html>
    <head>
        ...
        <title>Clinica Cruz del Norte</title>
    </head>
    ...
    <body>
        ...
        <section id="editar-cita" class="admin-section section py-5 bg-light">
            <div class="container section-title text-center mb-5" data-aos="fade-up">
                ...
                <p class="lead">Aquí tienes un resumen de los citas actuales de la clínica</p>
                <br>
                ...
                <div class="container">
                    ...
                    <div class="text-center mt-5">
                        <a  href="${pageContext.request.contextPath}/ControlCit" class="btn btn-primary btn-lg">
                            <i class="fas fa-plus-circle me-2"></i> Agregar Nueva Cita
                        </a>
                    </div>

                </div>
                <!-- Incluir el calendario dentro de un card para mejorar su presentación -->
